...
<body>
	...
	<main>
		<div class="container-md px-5">
			...
			<div class="mt-3">
				...
				<h2 class="text-center display-4 mt-3">Full Statement</h2>
			</div>

			<div class="row p-2">
				<input class="form-control col-lg-4" type="search"
					placeholder="Enter Account Number" aria-label="Search"
					id="searchId" name="accountNo">
				<button class="btn btn-outline-success col-lg-2 ml-2" type="button"
					onclick="getFullStmt()">Search</button>
			</div>
	...
	<script>
		function getFullStmt() {
			...
			$.ajax({
				type : 'GET',
				url : 'fullstmt', // Replace with the actual API endpoint
				data : {
